  ...
  >
    <div id="logo2dWrapper" class="rel">
      <canvas
        ...
        class="rel"
      ></canvas>
      <svg id="svgPlaceholder" viewBox="0 0 400 400" xmlns="http://www.w3.org/2000/svg">
...
function startAnimation() {
  ...
  const drawFunctions = [
    ...
    (progress) => {
      ctx.beginPath();
      ctx.ellipse(200, 107, 93, 93, Math.PI / 2, 0, (-Math.PI / 180) * progress, true);
      ctx.stroke();
    },
    (progress) => {
      ctx.beginPath();
      ctx.ellipse(200, 200, 186, 186, -Math.PI / 2, 0, (-Math.PI / 180) * progress, true);
      ctx.stroke();
    },
  ];
