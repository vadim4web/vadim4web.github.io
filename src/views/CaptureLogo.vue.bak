<template>
	<main class="main capture-logo-view w100 flex-col-center">
		<div id="github" class="node flex-center">
		...
		<div id="linkedin-profile" class="node flex-center">
			<span class="crafting"> Crafting Digital Solutions </span>
			<span class="vadim">
				<span class="v">v</span>
				<span class="a">a</span>
		...
		<div id="linkedin-company" class="node flex-center">
			<span class="crafting"> Crafting Digital Solutions </span>
			<span class="vadim">
				<span class="v">v</span>
				<span class="a">a</span>
		...
		<div id="facebook" class="node flex-center">
			<span class="crafting"> Crafting Digital Solutions </span>
			<span class="vadim">
				<span class="v">v</span>
				<span class="a">a</span>
...
.capture-logo-view {
	...
	@media (orientation: portrait) {
		margin: 10vmin 0 calc(100vh - 10vmin - 1539px - 3rem);
	}

	@media (orientation: landscape) {
		margin: 5vmin 0 calc(100vh - 5vmin - 1539px - 3rem);
	}
}
